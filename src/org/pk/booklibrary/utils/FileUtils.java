...
/**
 * Utility class for storing profile images.
 * 
 * @author PKCORP
 * @since 26/04/2017
 */
public class FileUtils {
	 ...
	 */
	private static final String[] ALLOWED_FILE_TYPES = new String[] { "png", "jpg", "ico", "jpeg" };
	 ...
	 */
	public static boolean writeToFile(InputStream uploadedInputStream, String path, String fileName, String saveAs) {
